...
**Active Flows** represent the number of workflows that can be enabled and running concurrently at any given time. Each plan includes a fixed concurrent flow limit.
...
:::info
Unlike AI Credit packs, extra flows are a **recurring add-on** — not a one-time purchase. Once bought, they are included in your plan at every renewal. To remove extra flows before your next renewal, contact our support team at [hello@appse.ai](mailto:hello@appse.ai).
:::
